    ...
    <>
      {data.map((item, index) => (
        ...
        <a className='Appointment-card' key={index} href={item.docLink}>
            <img src={`src/assets/${item.imgSrc}`} className='main' alt="img" />
            <p>{item.docName} <br /></p>
          ...
          <div className='flex-container'>
            <a href={item.locationLink} className="logos"><img src="src/assets/location.svg" alt="logo" /></a>
            <a href={item.calendarLink} className="logos"><img src="src/assets/calender.svg" alt="logo" /></a>
            <a href={item.refreshLink} className="logos"><img src="src/assets/refresh.svg" alt="logo" /></a>
          </div>
          </a>
      ))}
    </>
